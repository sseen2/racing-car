...
public class CarRestController {
    ...
    public ApiResponse<CarSuccessResponse> registerCar(@RequestBody @Valid CarRegisterRequest request) {
        carService.registerCar(request);
        return ApiResponse.success(CarSuccessResponse.REGISTER_CAR);
    }
}
